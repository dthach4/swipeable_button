          ...
          children: <Widget>[
            Padding(
              ...
              child: SwipeableButton.simple(
                label: const Center(child: Text("Simple blue button", style: TextStyle(color: Colors.white, fontSize: 16.0))),
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: SwipeableButton.simple(
                label: const Center(child: Text("Simple red button", style: TextStyle(color: Colors.white, fontSize: 16.0))),
            ...
            Padding(
              ...
              child: SwipeableButton(
                label: const Center(child: Text("Red to green thumb", style: TextStyle(color: Colors.white, fontSize: 16.0))),
                color: Colors.blue.shade400,
                thumbBuilder: (BuildContext context, double swipedFraction, bool hasSwiped) => DecoratedBox(
                  decoration: BoxDecoration(color: Color.lerp(Colors.red, Colors.green, swipedFraction)),
                  child: Row(
